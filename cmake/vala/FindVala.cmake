...
# Modified by Jukka-Pekka Partanen (jukpart@gmail.com) for a possibility to
# specify extra libraries to link in (e.g. libm)
...
find_package(GLIB2 ${_fv_glib_version} REQUIRED)
...
set(VALA_INCLUDE_DIRS "${GLIB2_INCLUDE_DIR}")
set(VALA_LIBRARIES "${GLIB2_LIBRARIES}")
set(VALA_DEV_LIBRARIES "${VALA_vala_LIBRARY}")

message (STATUS "VALA INCLUDE DIRS: ${VALA_INCLUDE_DIRS}")
message (STATUS "VALA LIBRARIES: ${VALA_LIBRARIES}")
